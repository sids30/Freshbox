...
-- CreateIndex
CREATE INDEX "Order_produceBoxId_idx" ON "Order"("produceBoxId");
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_produceBoxId_fkey" FOREIGN KEY ("produceBoxId") REFERENCES "ProduceBox"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
